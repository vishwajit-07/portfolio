...
//                     className="font-semibold text-white bg-orange-400 border border-black dark:border-white rounded-full px-4 py-1 hover:bg-orange-300 transition"
//                 >
//                     Hello!
//                 </button>
...
//                 <div className="w-72 h-72 md:w-96 md:h-96 rounded-full bg-orange-300 dark:bg-orange-500/50 absolute bottom-0"></div>
...
//                 {/* Added dark:text-white */}
//                 <p className="mt-4 font-semibold text-xl dark:text-white">Fresher</p>
//             </div>
//         </section>
//     );
// }
